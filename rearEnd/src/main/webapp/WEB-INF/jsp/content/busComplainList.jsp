...
<head>
    ...
    <script type="text/javascript">
        ...
        function modifyInit(id) {
            $("#mainForm").attr("action", $("#basePath").val() + "/complain/business/" + id);
            $("#mainForm").submit();
        }
...
<form action="${basePath}/complain/search/business" id="mainForm" method="post">
    <input type="hidden" id="id" name="id"/>
    <input type="hidden" id="message" value="${pageCode.msg}"/>
    <input type="hidden" id="basePath" value="${basePath}"/>
    <input type="hidden" name="page.currentPage" id="currentPage" value="1"/>
    <div class="right">
        <div class="current">当前位置：<a href="#">内容管理</a> &gt; 商户投诉管理</div>
        <div class="rightCont">
            <p class="g_title fix">投诉列表</p>
            <table class="tab1">
                <tbody>
                <tr>
                ...
                <table class="tab2" width="100%">
                    ...
                    <c:forEach items="${list}" var="item" varStatus="s">
                        <tr>
                            ...
                            <c:if test="${item.member.name != null}">
