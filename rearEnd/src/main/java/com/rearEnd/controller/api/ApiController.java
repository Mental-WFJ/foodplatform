package com.rearEnd.controller.api;

import com.rearEnd.constant.ApiCodeEnum;
import com.rearEnd.dto.*;
import com.rearEnd.entity.Member;
import com.rearEnd.entity.Page;
import com.rearEnd.service.*;
...
public class ApiController {
    ...
    public List<OrdersDto> orderlist(@PathVariable("username") Long username) {
        // 根据手机号取出会员ID
        Member m = memberService.getMemberByPhone(username);
