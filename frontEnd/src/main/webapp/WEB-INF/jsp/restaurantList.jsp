    ...
    <script type="text/javascript">
        ...
        function refreshByCity() {
            ...
            if (${sessionScope.member == null})
                location.href = "${basePath}/bussiness/search/null/" + cityId + "/null/null";
            else
                location.href = "${basePath}/bussiness/search/" + ${sessionScope.member.id} +"/" + cityId + "/null/null";
        }
        ...
        function search() {
            ...
            if (${sessionScope.member == null}) {
                if (${sessionScope.selectedCategory == null})
                    location.href = "${basePath}/bussiness/search/null/" + cityId + "/null/" + searchKey;
                else {
                    location.href = "${basePath}/bussiness/search/null/" + cityId + "/" + ${sessionScope.selectedCategory.id} +"/" + searchKey;
                }
            } else {
                if (${sessionScope.selectedCategory == null})
                    location.href = "${basePath}/bussiness/search/" + ${sessionScope.member.id} +"/" + cityId + "/null/" + searchKey;
                else {
                    location.href = "${basePath}/bussiness/search/" + ${sessionScope.member.id} +"/" + cityId + "/" + ${sessionScope.selectedCategory.id} +"/" + searchKey;
                }
            }
        }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav nav-main">
                ...
                <li class="active"><a>Restaurant</a></li>
                <li><a>ARTICLE</a></li>
                <li class="dropdown">
                ...
                <div class="product-grid" align="left">
                    <ul>
                        <c:forEach var="item" items="${bList}">
                            <c:if test="${tendency == item.category}">
                                <li>
                                    <div class="products">
                                        <c:if test="${member == null}">
                                            <a href="${basePath}/bussiness/article/${item.id}/null">
                                                <img src="http://${item.imgFileName}" alt=""
                                                     width="350px"
                                                     height="250px">
                                            </a>
                                        </c:if>
                                        <c:if test="${member != null}">
                                            <a href="${basePath}/bussiness/article/${item.id}/${member.id}">
                                                <img src="http://${item.imgFileName}" alt=""
                                                     width="350px"
                                                     height="250px">
                                            </a>
                                        ...
                                        <div class="caption">
                                            <p>人均：${item.price}元/人&nbsp;&nbsp;&nbsp;销售数量：${item.number}&nbsp;&nbsp;&nbsp;
                                                星级：${item.starTotalNum}</p>
                                        </div>    <!-- End of /.caption -->
                                    </div>    <!-- End of /.products -->
                                </li>
                            </c:if>
                ...
                <div class="blog-sidebar">
                    <div class="block">
                        ...
                        <div class="list-group">
                            ...
                            <c:if test="${member == null}">
                                <a href="${basePath}/bussiness/search/null/${selectedCity.id}/null/null"
                                   class="list-group-item">
                                    <i class="fa  fa-dot-circle-o"></i>
                                    全部
                                </a>
                                <c:forEach items="${categoryList}" var="cList">
                                    <a href="${basePath}/bussiness/search/null/${selectedCity.id}/${cList.id}/null"
                                       class="list-group-item">
                                        <i class="fa  fa-dot-circle-o"></i>
                                            ${cList.type}
                                    </a>
                            ...
                            <c:if test="${member != null}">
                                <a href="${basePath}/bussiness/search/${member.id}/${selectedCity.id}/null/null"
                                   class="list-group-item">
                                    <i class="fa  fa-dot-circle-o"></i>
                                    全部
                                </a>
                                <c:forEach items="${categoryList}" var="cList">
                                    <a href="${basePath}/bussiness/search/${member.id}/${selectedCity.id}/${cList.id}/null"
                                       class="list-group-item">
                                        <i class="fa  fa-dot-circle-o"></i>
                                            ${cList.type}
                                    </a>
